...
import { PanelLeftOpen, PanelLeftClose, MessageSquarePlus, Search, Menu, X, Home } from 'lucide-react';
...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-screen relative" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <Link 
        href="/" 
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 hover:bg-blue-700 shadow-lg transition-colors"
      >
      ...
      <div className={`flex-1 flex flex-col w-full ${!isSidebarOpen ? 'md:max-w-5xl md:mx-auto' : ''}`}>
        <div className="h-14 flex items-center px-4 justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold tracking-tight text-white ml-2 hidden md:block">Doc<span className="text-blue-500">0</span></h1>
          </div>
